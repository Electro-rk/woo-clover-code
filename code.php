 add_action( 'template_redirect', 'woo_create_order_in_clover' );

        function woo_create_order_in_clover (){
            ...
            $api_url = 'https://api.clover.com/v3/merchants/your-merchant-id/orders';
            ...
            if ($http_code === 200 && $order_status != 'failed') {
                        ...
                        if ($quantity > 0) {
                            for ($i = 0; $i < $quantity; $i++) {
                                ...
                                if (isset($responseData['id'])) {
                                    ...
                                    $apiUrl = 'https://api.clover.com/v3/merchants/your-merchant-id/orders/'.$orderId.'/bulk_line_items';
                ...
                $apiUrl = 'https://api.clover.com/v3/merchants/your-merchant-id/print_event'; // Replace mId with your actual merchant ID
